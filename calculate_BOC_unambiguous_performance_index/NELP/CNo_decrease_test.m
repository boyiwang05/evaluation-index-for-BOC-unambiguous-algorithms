...
%%
%%%相关器间隔
BW=30*1.023e6;d=0.1*Tc;Dz=1.42e-4;%BOC(10,5)相关器间隔
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N_BW=10000;
...
% end
savefile='CNo_desrease_test_NELP_method_BOC_10_5_30M_01Tc.mat';
save(savefile);
...
saveas(gcf,'CNo_desrease_test_NELP_method_BOC_10_5_30M_01Tc');

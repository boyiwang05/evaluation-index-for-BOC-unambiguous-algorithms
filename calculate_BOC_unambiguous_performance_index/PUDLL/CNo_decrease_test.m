...
%         N_CNo_sampling = floor(n/(  n_loop/length(C_N0_dB)))+1;
        N_CNo_sampling = ceil(n/(  n_loop/length(C_N0_dB)));
        %根据当前CNo加对应功率的噪声
...
% end
savefile='CNo_decrease_PUDLL_method_BOC_10_5_30M_01Tc_45dBHz.mat';
save(savefile);
...
figure;plot(n_loop,Trackerror,'Linewidth',2);grid on;
xlabel('time (ms)');
ylabel('code tracking error (meters)');
saveas(gcf,'CNo_decrease_test_PUDLL_method_BOC_10_5_30M_01Tc');

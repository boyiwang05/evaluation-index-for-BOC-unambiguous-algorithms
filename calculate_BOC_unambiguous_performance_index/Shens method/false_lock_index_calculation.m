...
%%
%%%相关器间隔
BW=36*1.023e6;d=0.03*Tc;K=0.1;Dz=1.23e-4;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N_BW=10000;
...
savefile='false_lock_index_shens_BOC_10_5_30M_01Tc_45dBHz.mat';
save(savefile);
...
saveas(gcf,'false_lock_index_shens_BOC_10_5_30M_01Tc_45dBHz');

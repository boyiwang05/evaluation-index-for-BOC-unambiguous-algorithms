...
%          [s_ref1_P,s_ref2_P,t_P]=yt_BOCs_SPAR_function(c,t_ref_begin,t_ref_end,Tc,fs,f_sample,Kass);    
...
savefile='false_lock_index_SPAR_BOC_10_5_30M_01Tc_45dBHz.mat';
save(savefile);
...
saveas(gcf,'false_lock_index_SPAR_BOC_10_5_30M_01Tc_45dBHz');
